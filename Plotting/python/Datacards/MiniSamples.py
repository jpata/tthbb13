...
samples_dict = {
    "ttH_hbb"        : path + "cfg_noME/ttHTobb_M125_13TeV_powheg_pythia8.root",
    #"ttH_nohbb"      : path + "ttHToNonbb_M125_13TeV_powheg_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2.root",        
    "ttbarPlus2B"    : path + "cfg_noME/TT_TuneCUETP8M1_13TeV-powheg-pythia8_tt2b.root",
    "ttbarPlusB"     : path + "cfg_noME/TT_TuneCUETP8M1_13TeV-powheg-pythia8_ttb.root",
    "ttbarPlusBBbar" : path + "cfg_noME/TT_TuneCUETP8M1_13TeV-powheg-pythia8_ttbb.root",
    "ttbarPlusCCbar" : path + "cfg_noME/TT_TuneCUETP8M1_13TeV-powheg-pythia8_ttcc.root",
    "ttbarOther"     : path + "cfg_noME/TT_TuneCUETP8M1_13TeV-powheg-pythia8_ttll.root",
