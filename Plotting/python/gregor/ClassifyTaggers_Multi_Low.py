...
for label in ["xtruth", "xnosize", "forWP"]:
...
#    setups[label].append(setup)
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, "OptRHTT_mass_frec_dr_groomed_tau", label),
                       ...
                       [["Cuts", "FitMethod=MC:Sigma=0.3:SampleSize=8000000:VarProp[1]=FSmart:VarProp[3]=FSmart:CutRangeMin[0]=0:CutRangeMax[0]=130:CutRangeMin[1]=0:CutRangeMax[1]=0.5:CutRangeMin[2]=-0.5:CutRangeMax[2]=0.5:CutRangeMin[3]=0:CutRangeMax[3]=1"]], 
                       [variable.di['looseOptRHTT_mass'],
                        variable.di['looseOptRHTT_fRec'],
                        variable.di['looseOptRHTT_Ropt-looseOptRHTT_RoptCalc'],
...
#    setups[label].append(setup)
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, "SD", label),
                      "log(#chi)",
                      [["Cuts", "V:FitMethod=MC:SampleSize=800000:Sigma=0.3:CutRangeMin[0]=-10:CutRangeMax[0]=8"]], 
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, "{0}_" + mass_var + "Mass_Tau", label.replace("x","")),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=1600000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=180:VarProp[0]=FSmart"]], 
                      [variable.di['ca15_tau3/ca15_tau2'],
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, mass_var + "Mass_Groomed_Tau", label),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=800000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=180:VarProp[0]=FSmart"]], 
                      [variable.di['ca15softdropz20b10_tau3/ca15softdropz20b10_tau2'],
                       variable.di[mass_var],
                   ],
                      [],
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, mass_var + "Mass_SD", label),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=900000:Sigma=0.3:CutRangeMin[0]=-10:CutRangeMax[0]=10:CutRangeMin[1]=0:CutRangeMax[1]=180"]], 
                      [variable.di['log(ca15_chi2)'],
                       variable.di[mass_var],
                   ],
                      [],
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, mass_var + "Mass_Groomed_Tau_SD", label),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=1600000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=180:VarProp[0]=FSmart:CutRangeMin[2]=-10:CutRangeMax[2]=10"]], 
                      [variable.di['ca15softdropz20b10_tau3/ca15softdropz20b10_tau2'],
                       variable.di[mass_var],
                       variable.di['log(ca15_chi2)']
                   ],
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, "OptRHTT_mass_frec_dr_groomed_tau_btag", label),
                       ...
                       [["Cuts", "FitMethod=MC:Sigma=0.3:SampleSize=4000000:VarProp[1]=FSmart:VarProp[3]=FSmart:VarProp[4]=FSmart:CutRangeMin[0]=0:CutRangeMax[0]=130:CutRangeMin[1]=0:CutRangeMax[1]=0.5:CutRangeMin[2]=-0.5:CutRangeMax[2]=0.5:CutRangeMin[3]=0:CutRangeMax[3]=1:CutRangeMin[4]=0:CutRangeMax[4]=1:"]], 
                       [variable.di['looseOptRHTT_mass'],
                        variable.di['looseOptRHTT_fRec'],
                        variable.di['looseOptRHTT_Ropt-looseOptRHTT_RoptCalc'],
                        variable.di['ca15softdropz20b10_tau3/ca15softdropz20b10_tau2'],
...
#    btag_setups[label].append(setup)
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, "SD_btag", label),
                      "log(#chi), b",
                      [["Cuts", "V:FitMethod=MC:SampleSize=400000:Sigma=0.3:CutRangeMin[0]=-10:CutRangeMax[0]=8:CutRangeMin[1]=0:CutRangeMax[1]=1.:VarProp[1]=FSmart"]], 
                      [variable.di['log(ca15_chi2)'],
                       variable.di['ca15softdropz20b10forbtag_btag'],
                   ],
                      [],
...
#    btag_setups[label].append(setup)
    ...
    setup = TMVASetup("{0}_{1}_{2}_{3}".format(sample_sig, sample_bkg, mass_var + "Mass_Groomed_Tau_btag", label),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=800000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=180:VarProp[0]=FSmart:CutRangeMin[2]=0:CutRangeMax[2]=1.:VarProp[2]=FSmart"]], 
                      [variable.di['ca15softdropz20b10_tau3/ca15softdropz20b10_tau2'],
                       variable.di[mass_var],
                       variable.di['ca15softdropz20b10forbtag_btag'],
                   ],
...
for label in [
    ...
    if label == "xtruth":
        plotROCs(label + "ROC_" + name, setups[label], pretty_fiducial_cuts[sample_sig], "#varepsilon(S) (merged hadronic top decays)")
        #plotROCs(label + "btag_ROC_" + name, btag_setups[label], pretty_fiducial_cuts[sample_sig], "#varepsilon(S) (merged hadronic top decays)")
    elif label == "xnosize":
        plotROCs(label + "ROC_" + name, setups[label], pretty_fiducial_cuts[sample_sig], "#varepsilon(S) (hadronic top decays)")
        #plotROCs(label + "btag_ROC_" + name, btag_setups[label], pretty_fiducial_cuts[sample_sig], "#varepsilon(S) (hadronic top decays)")
    else:
