...
for pair_name, pair in pairs.iteritems():
    ...
    setup = TMVASetup("{0}_{1}_{2}".format(sample_sig, sample_bkg, "Truth_CMSTT_tau"),
                       ...
                       [["Cuts", "FitMethod=MC:Sigma=0.3:SampleSize=500000:VarProp[2]=FSmart:CutRangeMin[0]=0:CutRangeMax[0]=150:CutRangeMin[1]=0:CutRangeMax[1]=300:CutRangeMin[2]=0:CutRangeMax[2]=1"]], 
    ...
    setup = TMVASetup("{0}_{1}_{2}".format(sample_sig, sample_bkg, "Truth_" + mass_var + "Mass_Tau"),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=400000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=200:VarProp[0]=FSmart"]], 
                      [variable.di['ak08_tau3/ak08_tau2'],
    ...
    setup = TMVASetup("{0}_{1}_{2}".format(sample_sig, sample_bkg, "Truth_" + mass_var + "Mass_Groomed_Tau"),
                      ...
                      [["Cuts", "V:FitMethod=MC:SampleSize=400000:Sigma=0.3:CutRangeMin[0]=0:CutRangeMax[0]=1:CutRangeMin[1]=0:CutRangeMax[1]=200:VarProp[0]=FSmart"]], 
                      [variable.di['ak08softdropz10b00_tau3/ak08softdropz10b00_tau2'],
                       variable.di[mass_var],
                   ],
                      [],
                      file_name_sig,
    ...
    setup = TMVASetup("{0}_{1}_{2}".format(sample_sig, sample_bkg, "Truth_btag_CMSTT_tau"),
                       "CMSTT - min. mass, top mass, #tau_{3}/#tau_{2}",
                       [["Cuts", "FitMethod=MC:Sigma=0.3:SampleSize=500000:VarProp[2]=FSmart:CutRangeMin[0]=0:CutRangeMax[0]=150:CutRangeMin[1]=0:CutRangeMax[1]=300:CutRangeMin[2]=0:CutRangeMax[2]=1"]], 
                       [variable.di['ak08cmstt_minMass'],
                        variable.di['ak08cmstt_topMass'],
