...
for name,samples in [ ["low", lows], 
    ...
    if True:
        for var in masses:
            ...
            combinedPlot("nosize_" + var.replace("/","_")+"_"+name,
    ...
    if False:
        for var in others:
            ...
            combinedPlot("nosize_masscut_" + var.replace("/","_")+"_"+name,
                         [plot(other2_sample_names[sample],
                               variable.di[var.replace("X",ranges[sample][4])].name,                                           
...
#
#        if False:
#            combinedPlot(var.replace("/","_")+"_"+name,
#                         [plot(other3_sample_names[sample] if "HTT" in var else other2_sample_names[sample],
#                               variable.di[var.replace("X",ranges[sample][4])].name,                                           
