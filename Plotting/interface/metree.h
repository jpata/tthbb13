...
public:
  ...
  int othertopCandidate_genTopHad_index[4]; //Index of the matched genTopHad
  ...
  int topCandidate_genTopHad_index[1]; //Index of the matched genTopHad
  ...
  void loadTree(TTree* tree) {
    ...
    tree->SetBranchAddress("othertopCandidate_genTopHad_index", this->othertopCandidate_genTopHad_index);
    ...
    tree->SetBranchAddress("genTopHad_id", this->genTopHad_id);
    ...
    tree->SetBranchAddress("genTopLep_id", this->genTopLep_id);
    ...
    tree->SetBranchAddress("topCandidate_genTopHad_index", this->topCandidate_genTopHad_index);
