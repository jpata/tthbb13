...
def process_event(event, intree):
    event.FatjetAK08ungroomed = FatjetAK08ungroomed.make_array(intree)
    event.FatjetCA15pruned = FatjetCA15pruned.make_array(intree)
    event.FatjetCA15softdrop = FatjetCA15softdrop.make_array(intree)
    event.FatjetCA15softdropfilt = FatjetCA15softdropfilt.make_array(intree)
    event.FatjetCA15softdropz2b1 = FatjetCA15softdropz2b1.make_array(intree)
    event.FatjetCA15softdropz2b1filt = FatjetCA15softdropz2b1filt.make_array(intree)
    event.FatjetCA15subjetfiltered = FatjetCA15subjetfiltered.make_array(intree)
    event.FatjetCA15trimmed = FatjetCA15trimmed.make_array(intree)
    event.FatjetCA15ungroomed = FatjetCA15ungroomed.make_array(intree)
    event.Flag_hbheFilterNew = getattr(intree, "Flag_hbheFilterNew", None)
    event.Flag_hbheIsoFilter = getattr(intree, "Flag_hbheIsoFilter", None)
    event.GenBQuarkFromH = GenBQuarkFromH.make_array(intree)
    event.GenBQuarkFromHafterISR = GenBQuarkFromHafterISR.make_array(intree)
    event.GenBQuarkFromTop = GenBQuarkFromTop.make_array(intree)
    event.GenGluonFromB = GenGluonFromB.make_array(intree)
    event.GenGluonFromTop = GenGluonFromTop.make_array(intree)
    event.GenHadTaus = GenHadTaus.make_array(intree)
    event.GenHiggsBoson = GenHiggsBoson.make_array(intree)
    event.GenHiggsSisters = GenHiggsSisters.make_array(intree)
    event.GenJet = GenJet.make_array(intree)
    event.GenLep = GenLep.make_array(intree)
    event.GenLepFromTau = GenLepFromTau.make_array(intree)
    event.GenLepFromTauRecovered = GenLepFromTauRecovered.make_array(intree)
    event.GenLepFromTop = GenLepFromTop.make_array(intree)
    event.GenLepRecovered = GenLepRecovered.make_array(intree)
    event.GenNuFromTop = GenNuFromTop.make_array(intree)
    event.GenStatus2bHad = GenStatus2bHad.make_array(intree)
    event.GenTaus = GenTaus.make_array(intree)
    event.GenTausRecovered = GenTausRecovered.make_array(intree)
    event.GenTop = GenTop.make_array(intree)
    event.GenVbosons = GenVbosons.make_array(intree)
    event.GenVbosonsRecovered = GenVbosonsRecovered.make_array(intree)
    event.GenWZQuark = GenWZQuark.make_array(intree)
    event.H = H.make_obj(intree)
    event.HCMVAV2 = HCMVAV2.make_obj(intree)
    event.HCMVAV2_reg = HCMVAV2_reg.make_obj(intree)
    event.HCMVAV2_reg_corrJECDown = HCMVAV2_reg_corrJECDown.make_obj(intree)
    event.HCMVAV2_reg_corrJECUp = HCMVAV2_reg_corrJECUp.make_obj(intree)
    event.HCMVAV2_reg_corrJERDown = HCMVAV2_reg_corrJERDown.make_obj(intree)
    event.HCMVAV2_reg_corrJERUp = HCMVAV2_reg_corrJERUp.make_obj(intree)
    event.HCSV = HCSV.make_obj(intree)
    event.HCSV_reg = HCSV_reg.make_obj(intree)
    event.HCSV_reg_corrJECDown = HCSV_reg_corrJECDown.make_obj(intree)
    event.HCSV_reg_corrJECUp = HCSV_reg_corrJECUp.make_obj(intree)
    event.HCSV_reg_corrJERDown = HCSV_reg_corrJERDown.make_obj(intree)
    event.HCSV_reg_corrJERUp = HCSV_reg_corrJERUp.make_obj(intree)
    event.HVdPhi = getattr(intree, "HVdPhi", None)
    event.H_reg = H_reg.make_obj(intree)
    event.H_reg_corrJECDown = H_reg_corrJECDown.make_obj(intree)
    event.H_reg_corrJECUp = H_reg_corrJECUp.make_obj(intree)
    event.H_reg_corrJERDown = H_reg_corrJERDown.make_obj(intree)
    event.H_reg_corrJERUp = H_reg_corrJERUp.make_obj(intree)
    event.HaddJetsdR08 = HaddJetsdR08.make_obj(intree)
    event.Jet = Jet.make_array(intree)
    event.LHE_weights_pdf = LHE_weights_pdf.make_array(intree)
    event.LHE_weights_scale = LHE_weights_scale.make_array(intree)
    event.SubjetAK08softdrop = SubjetAK08softdrop.make_array(intree)
    event.SubjetCA15pruned = SubjetCA15pruned.make_array(intree)
    event.SubjetCA15softdrop = SubjetCA15softdrop.make_array(intree)
    event.SubjetCA15softdropfilt = SubjetCA15softdropfilt.make_array(intree)
    event.SubjetCA15softdropz2b1 = SubjetCA15softdropz2b1.make_array(intree)
    event.SubjetCA15softdropz2b1filt = SubjetCA15softdropz2b1filt.make_array(intree)
    event.SubjetCA15subjetfiltered = SubjetCA15subjetfiltered.make_array(intree)
    event.TauGood = TauGood.make_array(intree)
    event.V = V.make_obj(intree)
    event.VMt = getattr(intree, "VMt", None)
    event.Vtype = getattr(intree, "Vtype", None)
    event.VtypeSim = getattr(intree, "VtypeSim", None)
    event.aJCMVAV2idx = aJCMVAV2idx.make_array(intree)
    event.aJCidx = aJCidx.make_array(intree)
    event.aJidx = aJidx.make_array(intree)
    event.aLeptons = aLeptons.make_array(intree)
    event.ajidxaddJetsdR08 = ajidxaddJetsdR08.make_array(intree)
    event.btagWeightCMVAV2 = getattr(intree, "btagWeightCMVAV2", None)
    event.btagWeightCMVAV2_down_cferr1 = getattr(intree, "btagWeightCMVAV2_down_cferr1", None)
    event.btagWeightCMVAV2_down_cferr2 = getattr(intree, "btagWeightCMVAV2_down_cferr2", None)
    event.btagWeightCMVAV2_down_hf = getattr(intree, "btagWeightCMVAV2_down_hf", None)
    event.btagWeightCMVAV2_down_hfstats1 = getattr(intree, "btagWeightCMVAV2_down_hfstats1", None)
    event.btagWeightCMVAV2_down_hfstats2 = getattr(intree, "btagWeightCMVAV2_down_hfstats2", None)
    event.btagWeightCMVAV2_down_jes = getattr(intree, "btagWeightCMVAV2_down_jes", None)
    event.btagWeightCMVAV2_down_lf = getattr(intree, "btagWeightCMVAV2_down_lf", None)
    event.btagWeightCMVAV2_down_lfstats1 = getattr(intree, "btagWeightCMVAV2_down_lfstats1", None)
    event.btagWeightCMVAV2_down_lfstats2 = getattr(intree, "btagWeightCMVAV2_down_lfstats2", None)
    event.btagWeightCMVAV2_up_cferr1 = getattr(intree, "btagWeightCMVAV2_up_cferr1", None)
    event.btagWeightCMVAV2_up_cferr2 = getattr(intree, "btagWeightCMVAV2_up_cferr2", None)
    event.btagWeightCMVAV2_up_hf = getattr(intree, "btagWeightCMVAV2_up_hf", None)
    event.btagWeightCMVAV2_up_hfstats1 = getattr(intree, "btagWeightCMVAV2_up_hfstats1", None)
    event.btagWeightCMVAV2_up_hfstats2 = getattr(intree, "btagWeightCMVAV2_up_hfstats2", None)
    event.btagWeightCMVAV2_up_jes = getattr(intree, "btagWeightCMVAV2_up_jes", None)
    event.btagWeightCMVAV2_up_lf = getattr(intree, "btagWeightCMVAV2_up_lf", None)
    event.btagWeightCMVAV2_up_lfstats1 = getattr(intree, "btagWeightCMVAV2_up_lfstats1", None)
    event.btagWeightCMVAV2_up_lfstats2 = getattr(intree, "btagWeightCMVAV2_up_lfstats2", None)
    event.btagWeightCSV = getattr(intree, "btagWeightCSV", None)
    event.btagWeightCSV_down_cferr1 = getattr(intree, "btagWeightCSV_down_cferr1", None)
    event.btagWeightCSV_down_cferr2 = getattr(intree, "btagWeightCSV_down_cferr2", None)
    event.btagWeightCSV_down_hf = getattr(intree, "btagWeightCSV_down_hf", None)
    event.btagWeightCSV_down_hfstats1 = getattr(intree, "btagWeightCSV_down_hfstats1", None)
    event.btagWeightCSV_down_hfstats2 = getattr(intree, "btagWeightCSV_down_hfstats2", None)
    event.btagWeightCSV_down_jes = getattr(intree, "btagWeightCSV_down_jes", None)
    event.btagWeightCSV_down_lf = getattr(intree, "btagWeightCSV_down_lf", None)
    event.btagWeightCSV_down_lfstats1 = getattr(intree, "btagWeightCSV_down_lfstats1", None)
    event.btagWeightCSV_down_lfstats2 = getattr(intree, "btagWeightCSV_down_lfstats2", None)
    event.btagWeightCSV_up_cferr1 = getattr(intree, "btagWeightCSV_up_cferr1", None)
    event.btagWeightCSV_up_cferr2 = getattr(intree, "btagWeightCSV_up_cferr2", None)
    event.btagWeightCSV_up_hf = getattr(intree, "btagWeightCSV_up_hf", None)
    event.btagWeightCSV_up_hfstats1 = getattr(intree, "btagWeightCSV_up_hfstats1", None)
    event.btagWeightCSV_up_hfstats2 = getattr(intree, "btagWeightCSV_up_hfstats2", None)
    event.btagWeightCSV_up_jes = getattr(intree, "btagWeightCSV_up_jes", None)
    event.btagWeightCSV_up_lf = getattr(intree, "btagWeightCSV_up_lf", None)
    event.btagWeightCSV_up_lfstats1 = getattr(intree, "btagWeightCSV_up_lfstats1", None)
    event.btagWeightCSV_up_lfstats2 = getattr(intree, "btagWeightCSV_up_lfstats2", None)
    event.bx = getattr(intree, "bx", None)
    event.caloMetPhi = getattr(intree, "caloMetPhi", None)
    event.caloMetPt = getattr(intree, "caloMetPt", None)
    event.dRaddJetsdR08 = dRaddJetsdR08.make_array(intree)
    event.deltaR_jj = getattr(intree, "deltaR_jj", None)
    event.fakeMET = fakeMET.make_obj(intree)
    event.fakeMET_sumet = getattr(intree, "fakeMET_sumet", None)
    event.genHiggsDecayMode = getattr(intree, "genHiggsDecayMode", None)
    event.genTTHtoTauTauDecayMode = getattr(intree, "genTTHtoTauTauDecayMode", None)
    event.hJCMVAV2idx = hJCMVAV2idx.make_array(intree)
    event.hJCidx = hJCidx.make_array(intree)
    event.hJidx = hJidx.make_array(intree)
    event.hJidx_sortcsv = hJidx_sortcsv.make_array(intree)
    event.heavyFlavourCategory = getattr(intree, "heavyFlavourCategory", None)
    event.hjidxaddJetsdR08 = hjidxaddJetsdR08.make_array(intree)
    event.htJet30 = getattr(intree, "htJet30", None)
    event.httCandidates = httCandidates.make_array(intree)
    event.isrJetVH = getattr(intree, "isrJetVH", None)
    event.json = getattr(intree, "json", None)
    event.json_silver = getattr(intree, "json_silver", None)
    event.lheHT = getattr(intree, "lheHT", None)
    event.lheNb = getattr(intree, "lheNb", None)
    event.lheNc = getattr(intree, "lheNc", None)
    event.lheNg = getattr(intree, "lheNg", None)
    event.lheNj = getattr(intree, "lheNj", None)
    event.lheNl = getattr(intree, "lheNl", None)
    event.lheV_pt = getattr(intree, "lheV_pt", None)
    event.met = met.make_obj(intree)
    event.metPuppi_phi = getattr(intree, "metPuppi_phi", None)
    event.metPuppi_pt = getattr(intree, "metPuppi_pt", None)
    event.metPuppi_rawpt = getattr(intree, "metPuppi_rawpt", None)
    event.metType1p2_pt = getattr(intree, "metType1p2_pt", None)
    event.met_rawpt = getattr(intree, "met_rawpt", None)
    event.met_shifted_ElectronEnDown = met_shifted_ElectronEnDown.make_obj(intree)
    event.met_shifted_ElectronEnUp = met_shifted_ElectronEnUp.make_obj(intree)
    event.met_shifted_JetEnDown = met_shifted_JetEnDown.make_obj(intree)
    event.met_shifted_JetEnUp = met_shifted_JetEnUp.make_obj(intree)
    event.met_shifted_JetResDown = met_shifted_JetResDown.make_obj(intree)
    event.met_shifted_JetResUp = met_shifted_JetResUp.make_obj(intree)
    event.met_shifted_MuonEnDown = met_shifted_MuonEnDown.make_obj(intree)
    event.met_shifted_MuonEnUp = met_shifted_MuonEnUp.make_obj(intree)
    event.met_shifted_TauEnDown = met_shifted_TauEnDown.make_obj(intree)
    event.met_shifted_TauEnUp = met_shifted_TauEnUp.make_obj(intree)
    event.met_shifted_UnclusteredEnDown = met_shifted_UnclusteredEnDown.make_obj(intree)
    event.met_shifted_UnclusteredEnUp = met_shifted_UnclusteredEnUp.make_obj(intree)
    event.met_sig = getattr(intree, "met_sig", None)
    event.mhtJet30 = getattr(intree, "mhtJet30", None)
    event.mhtPhiJet30 = getattr(intree, "mhtPhiJet30", None)
    event.nPU0 = getattr(intree, "nPU0", None)
    event.nPVs = getattr(intree, "nPVs", None)
    event.pileUpVertex_ptHat = pileUpVertex_ptHat.make_array(intree)
    event.pileUpVertex_z = pileUpVertex_z.make_array(intree)
    event.primaryVertices = primaryVertices.make_array(intree)
    event.puWeightDown = getattr(intree, "puWeightDown", None)
    event.puWeightUp = getattr(intree, "puWeightUp", None)
    event.rho = getattr(intree, "rho", None)
    event.rhoCHPU = getattr(intree, "rhoCHPU", None)
    event.rhoCentral = getattr(intree, "rhoCentral", None)
    event.rhoN = getattr(intree, "rhoN", None)
    event.selLeptons = selLeptons.make_array(intree)
    event.simPrimaryVertex_z = getattr(intree, "simPrimaryVertex_z", None)
    event.softActivity = softActivity.make_obj(intree)
    event.softActivityJets = softActivityJets.make_array(intree)
    event.softActivityVH = softActivityVH.make_obj(intree)
    event.softActivityVHJets = softActivityVHJets.make_array(intree)
    event.tkMetPVchs_phi = getattr(intree, "tkMetPVchs_phi", None)
    event.tkMetPVchs_pt = getattr(intree, "tkMetPVchs_pt", None)
    event.tkMet_phi = getattr(intree, "tkMet_phi", None)
    event.tkMet_pt = getattr(intree, "tkMet_pt", None)
    event.trgObjects_caloJets = trgObjects_caloJets.make_array(intree)
    event.trgObjects_caloMet = trgObjects_caloMet.make_array(intree)
    event.trgObjects_caloMht = trgObjects_caloMht.make_array(intree)
    event.trgObjects_caloMhtNoPU = trgObjects_caloMhtNoPU.make_array(intree)
    event.trgObjects_hltBTagCaloCSVp014DoubleWithMatching = trgObjects_hltBTagCaloCSVp014DoubleWithMatching.make_array(intree)
    event.trgObjects_hltBTagCaloCSVp022Single = trgObjects_hltBTagCaloCSVp022Single.make_array(intree)
    event.trgObjects_hltBTagCaloCSVp026DoubleWithMatching = trgObjects_hltBTagCaloCSVp026DoubleWithMatching.make_array(intree)
    event.trgObjects_hltBTagCaloCSVp067Single = trgObjects_hltBTagCaloCSVp067Single.make_array(intree)
    event.trgObjects_hltBTagCaloCSVp087Triple = trgObjects_hltBTagCaloCSVp087Triple.make_array(intree)
    event.trgObjects_hltBTagPFCSVp016SingleWithMatching = trgObjects_hltBTagPFCSVp016SingleWithMatching.make_array(intree)
    event.trgObjects_hltBTagPFCSVp11DoubleWithMatching = trgObjects_hltBTagPFCSVp11DoubleWithMatching.make_array(intree)
    event.trgObjects_hltDoubleCentralJet90 = trgObjects_hltDoubleCentralJet90.make_array(intree)
    event.trgObjects_hltDoubleJet65 = trgObjects_hltDoubleJet65.make_array(intree)
    event.trgObjects_hltDoublePFCentralJetLooseID90 = trgObjects_hltDoublePFCentralJetLooseID90.make_array(intree)
    event.trgObjects_hltDoublePFJetsC100 = trgObjects_hltDoublePFJetsC100.make_array(intree)
    event.trgObjects_hltEle25WPTight = trgObjects_hltEle25WPTight.make_array(intree)
    event.trgObjects_hltEle25eta2p1WPLoose = trgObjects_hltEle25eta2p1WPLoose.make_array(intree)
    event.trgObjects_hltIsoMu20 = trgObjects_hltIsoMu20.make_array(intree)
    event.trgObjects_hltL1sETM50ToETM100IorETM60Jet60dPhiMin0p4IorDoubleJetC60ETM60 = trgObjects_hltL1sETM50ToETM100IorETM60Jet60dPhiMin0p4IorDoubleJetC60ETM60.make_array(intree)
    event.trgObjects_hltL1sQuadJetCIorTripleJetVBFIorHTT = trgObjects_hltL1sQuadJetCIorTripleJetVBFIorHTT.make_array(intree)
    event.trgObjects_hltL1sTripleJetVBFIorHTTIorDoubleJetCIorSingleJet = trgObjects_hltL1sTripleJetVBFIorHTTIorDoubleJetCIorSingleJet.make_array(intree)
    event.trgObjects_hltMET70 = trgObjects_hltMET70.make_array(intree)
    event.trgObjects_hltMHT70 = trgObjects_hltMHT70.make_array(intree)
    event.trgObjects_hltMHTNoPU90 = trgObjects_hltMHTNoPU90.make_array(intree)
    event.trgObjects_hltPFDoubleJetLooseID76 = trgObjects_hltPFDoubleJetLooseID76.make_array(intree)
    event.trgObjects_hltPFMET90 = trgObjects_hltPFMET90.make_array(intree)
    event.trgObjects_hltPFMHTTightID90 = trgObjects_hltPFMHTTightID90.make_array(intree)
    event.trgObjects_hltPFQuadJetLooseID15 = trgObjects_hltPFQuadJetLooseID15.make_array(intree)
    event.trgObjects_hltPFSingleJetLooseID92 = trgObjects_hltPFSingleJetLooseID92.make_array(intree)
    event.trgObjects_hltPFTripleJetLooseID64 = trgObjects_hltPFTripleJetLooseID64.make_array(intree)
    event.trgObjects_hltQuadCentralJet30 = trgObjects_hltQuadCentralJet30.make_array(intree)
    event.trgObjects_hltQuadCentralJet45 = trgObjects_hltQuadCentralJet45.make_array(intree)
    event.trgObjects_hltQuadJet15 = trgObjects_hltQuadJet15.make_array(intree)
    event.trgObjects_hltQuadPFCentralJetLooseID30 = trgObjects_hltQuadPFCentralJetLooseID30.make_array(intree)
    event.trgObjects_hltQuadPFCentralJetLooseID45 = trgObjects_hltQuadPFCentralJetLooseID45.make_array(intree)
    event.trgObjects_hltSingleJet80 = trgObjects_hltSingleJet80.make_array(intree)
    event.trgObjects_hltTripleJet50 = trgObjects_hltTripleJet50.make_array(intree)
    event.trgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5 = trgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5.make_array(intree)
    event.trgObjects_hltVBFPFJetCSVSortedMqq200Detaqq1p2 = trgObjects_hltVBFPFJetCSVSortedMqq200Detaqq1p2.make_array(intree)
    event.trgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1 = trgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1.make_array(intree)
    event.trgObjects_pfHt = trgObjects_pfHt.make_array(intree)
    event.trgObjects_pfJets = trgObjects_pfJets.make_array(intree)
    event.trgObjects_pfMet = trgObjects_pfMet.make_array(intree)
    event.trgObjects_pfMht = trgObjects_pfMht.make_array(intree)
    event.triggerEmulationWeight = getattr(intree, "triggerEmulationWeight", None)
    event.ttCls = getattr(intree, "ttCls", None)
    event.vLeptons = vLeptons.make_array(intree)
