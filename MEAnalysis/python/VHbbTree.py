...
class GenJet:
    ...
    def make_array(tree):
        ...
        return [GenJet(_pdgId[n], _pt[n], _eta[n], _phi[n], _mass[n], _charge[n], _status[n]) for n in range(n)]
    def __init__(self, pdgId,pt,eta,phi,mass,charge,status):
        self.pdgId = pdgId #
        self.pt = pt #
        self.eta = eta #
...
class Jet:
    ...
    def __str__(self):
        return "j({0:.1f}, {1:.1f}, {2:.1f})".format(self.pt, self.eta, self.phi)
