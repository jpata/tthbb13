...
process.fwliteInput = cms.PSet(
    ...
    pathToFile    = cms.string("/pnfs/psi.ch/cms/trivcat/store/user/jpata/tth/dec19_5b21f5f"), #works on T3_PSI_CH
    #pathToFile    = cms.string("/hdfs/cms/store/user/jpata/tth//dec19_5b21f5f/"), #use MEAnalysis_cfg_EE.py
