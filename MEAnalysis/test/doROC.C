...
void run_SL_opt( TString gcS1 = "GCdd371ba1cc90", TString gcB1 = "GC399bef150c46"
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets>=7 && nBCSVM>=4 && mem_tth_nperm[0]>0"),
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets==4 && nBCSVM>=4 && mem_tth_nperm[0]>0"),
	       "SL, N_{b}#geq4, N_{j}=4",
	       "OPT_SL_4_g4.png"                                               
	       );
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets==5 && nBCSVM>=4 && mem_tth_nperm[0]>0"),
	       "SL, N_{b}#geq4, N_{j}=5",
	       "OPT_SL_5_g4.png"                                               
	       );
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets==6 && nBCSVM>=4 && mem_tth_nperm[0]>0"),
	       "SL, N_{b}#geq4, N_{j}=6",
	       "OPT_SL_6_g4.png"                                               
	       );
  ...
  */
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets==4 && nBCSVM==3  && mem_tth_nperm[0]>0"),
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets==5 && nBCSVM==3 && mem_tth_nperm[0]>0"),
  ...
  roc_opt_ROC( fS1, fB1,
	       0,
	       sl && TCut("njets>=6 && nBCSVM==3 && mem_tth_nperm[0]>0"),
