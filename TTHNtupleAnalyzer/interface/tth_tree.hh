...
public:
	...
	int good_lep__charge[N_MAX];
	float good_lep__eta[N_MAX];
	int good_lep__id[N_MAX];
	int good_lep__idx[N_MAX];
	float good_lep__mass[N_MAX];
	float good_lep__phi[N_MAX];
	float good_lep__pt[N_MAX];
	float good_lep__rel_iso[N_MAX];
	int good_lep__type[N_MAX];
	...
	void loop_initialize(void) {
		...
		SET_ZERO(good_lep__charge, N_MAX, DEF_VAL_INT);
		SET_ZERO(good_lep__eta, N_MAX, DEF_VAL_FLOAT);
		SET_ZERO(good_lep__id, N_MAX, DEF_VAL_INT);
		SET_ZERO(good_lep__idx, N_MAX, DEF_VAL_INT);
		SET_ZERO(good_lep__mass, N_MAX, DEF_VAL_FLOAT);
		SET_ZERO(good_lep__phi, N_MAX, DEF_VAL_FLOAT);
		SET_ZERO(good_lep__pt, N_MAX, DEF_VAL_FLOAT);
		SET_ZERO(good_lep__rel_iso, N_MAX, DEF_VAL_FLOAT);
		SET_ZERO(good_lep__type, N_MAX, DEF_VAL_INT);
	...
	void make_branches(void) {
		...
		tree->Branch("n__good_lep", &n__good_lep, "n__good_lep/I");
		...
		tree->Branch("good_lep__charge", good_lep__charge, "good_lep__charge[n__good_lep]/I");
		tree->Branch("good_lep__eta", good_lep__eta, "good_lep__eta[n__good_lep]/F");
		tree->Branch("good_lep__id", good_lep__id, "good_lep__id[n__good_lep]/I");
		tree->Branch("good_lep__idx", good_lep__idx, "good_lep__idx[n__good_lep]/I");
		tree->Branch("good_lep__mass", good_lep__mass, "good_lep__mass[n__good_lep]/F");
		tree->Branch("good_lep__phi", good_lep__phi, "good_lep__phi[n__good_lep]/F");
		tree->Branch("good_lep__pt", good_lep__pt, "good_lep__pt[n__good_lep]/F");
		tree->Branch("good_lep__rel_iso", good_lep__rel_iso, "good_lep__rel_iso[n__good_lep]/F");
		tree->Branch("good_lep__type", good_lep__type, "good_lep__type[n__good_lep]/I");
	...
	void set_branch_addresses(void) {
		...
		tree->SetBranchAddress("good_lep__charge", good_lep__charge);
		tree->SetBranchAddress("good_lep__eta", good_lep__eta);
		tree->SetBranchAddress("good_lep__id", good_lep__id);
		tree->SetBranchAddress("good_lep__idx", good_lep__idx);
		tree->SetBranchAddress("good_lep__mass", good_lep__mass);
		tree->SetBranchAddress("good_lep__phi", good_lep__phi);
		tree->SetBranchAddress("good_lep__pt", good_lep__pt);
		tree->SetBranchAddress("good_lep__rel_iso", good_lep__rel_iso);
		tree->SetBranchAddress("good_lep__type", good_lep__type);
		...
		tree->SetBranchAddress("n__good_lep", &n__good_lep);
